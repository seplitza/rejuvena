...
class PaymentCancelledPopup extends Component {
  render() {
    const {t, hide, visible, gotoFeedback} = this.props;
    return (
      <Modal
        visible={visible}
        animationType="fade"
        ...
        <View style={styles.container}>
          ...
          <Label style={styles.messageStyle}>
            {t('coursePage.paymentCancelledMessage')}
          </Label>
          <Button
            title={t('coursePage.feedback')}
            containerStyle={styles.buttonStyle}
            titleStyle={styles.buttonTitleStyle}
            onPress={gotoFeedback}
          />
          <Label style={styles.laterLabelStyle} onPress={hide}>
            {t('coursePage.later')}
          </Label>
        </View>
