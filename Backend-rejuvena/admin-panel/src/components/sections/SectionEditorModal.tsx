          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setLocalData({ ...localData, sectionTitle: e.target.value })}
            ...
            <GalleryEditor
              ...
              onChange={(images) => setLocalData({ ...localData, images })}
              sectionTitle="Фотографии результатов"
            />
          </div>
        );
      case 'testimonialsGallery':
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Заголовок секции</label>
            ...
            <GalleryEditor
              images={localData.images || []}
              onChange={(images) => setLocalData({ ...localData, images })}
              sectionTitle="Фотографии отзывов"
            />
          </div>
        );
      default:
